...
QtObject {
    ...
    readonly property int       radius : 25
    ...
    readonly property color foregroundHovered: "#a3a2a7";
    readonly property color foregroundFocused: "#a38071";

    readonly property color borderActivated: "#eef0f2";
    ...
    readonly property color primary: "#111315";
